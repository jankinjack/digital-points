...
################################################################################
## Form generated from reading UI file 'ui_form_import_csv.ui'
##
...
"}")
        ...
        self.gridLayout_7 = QGridLayout(self.frameTop_3)
        self.gridLayout_7.setSpacing(0)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.gridLayout_7.setContentsMargins(5, 0, 5, 0)
        self.pushButtonImportCSV = QPushButton(self.frameTop_3)
        self.pushButtonImportCSV.setObjectName(u"pushButtonImportCSV")
        self.pushButtonImportCSV.setMinimumSize(QSize(100, 0))
        self.pushButtonImportCSV.setMaximumSize(QSize(16777215, 40))
...
"}")
        ...
        self.gridLayout_7.addWidget(self.pushButtonImportCSV, 0, 0, 1, 1)


        self.horizontalLayout_2.addWidget(self.frameTop_3)
...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.frameTop_1)
...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.frameTop_2)
...
"}")
        ...
        if (self.tableWidgetVariables.columnCount() < 1):
            self.tableWidgetVariables.setColumnCount(1)
        ...
        sizePolicy1.setHeightForWidth(self.tableWidgetVariables.sizePolicy().hasHeightForWidth())
        self.tableWidgetVariables.setSizePolicy(sizePolicy1)
...
"}")
        ...
        if (self.tableWidgetVariableSelected_1.columnCount() < 2):
            self.tableWidgetVariableSelected_1.setColumnCount(2)
        __qtablewidgetitem1 = QTableWidgetItem()
        __qtablewidgetitem1.setTextAlignment(Qt.AlignLeading|Qt.AlignVCenter)
        self.tableWidgetVariableSelected_1.setHorizontalHeaderItem(0, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        self.tableWidgetVariableSelected_1.setHorizontalHeaderItem(1, __qtablewidgetitem2)
        self.tableWidgetVariableSelected_1.setObjectName(u"tableWidgetVariableSelected_1")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.tableWidgetVariableSelected_1.sizePolicy().hasHeightForWidth())
        self.tableWidgetVariableSelected_1.setSizePolicy(sizePolicy2)
...
"}")
        ...
        if (self.tableWidgetVariableSelected_2.columnCount() < 2):
            self.tableWidgetVariableSelected_2.setColumnCount(2)
        __qtablewidgetitem3 = QTableWidgetItem()
        __qtablewidgetitem3.setTextAlignment(Qt.AlignLeading|Qt.AlignVCenter)
        self.tableWidgetVariableSelected_2.setHorizontalHeaderItem(0, __qtablewidgetitem3)
        __qtablewidgetitem4 = QTableWidgetItem()
        self.tableWidgetVariableSelected_2.setHorizontalHeaderItem(1, __qtablewidgetitem4)
        self.tableWidgetVariableSelected_2.setObjectName(u"tableWidgetVariableSelected_2")
        sizePolicy2.setHeightForWidth(self.tableWidgetVariableSelected_2.sizePolicy().hasHeightForWidth())
        self.tableWidgetVariableSelected_2.setSizePolicy(sizePolicy2)
...
"}")
    ...
    def retranslateUi(self, Window_Main):
        ...
        self.pushButtonImportCSV.setText(QCoreApplication.translate("Window_Main", u"Import", None))
        self.label_4.setText(QCoreApplication.translate("Window_Main", u"Import CSV", None))
        ...
        self.label_2.setText(QCoreApplication.translate("Window_Main", u"Graph 1", None))
        ___qtablewidgetitem1 = self.tableWidgetVariableSelected_1.horizontalHeaderItem(0)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Window_Main", u"Name", None))
        ___qtablewidgetitem2 = self.tableWidgetVariableSelected_1.horizontalHeaderItem(1)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Window_Main", u"Time Shift", None))
        self.label.setText(QCoreApplication.translate("Window_Main", u"Graph 2", None))
        ___qtablewidgetitem3 = self.tableWidgetVariableSelected_2.horizontalHeaderItem(0)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Window_Main", u"Name", None))
        ___qtablewidgetitem4 = self.tableWidgetVariableSelected_2.horizontalHeaderItem(1)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Window_Main", u"Time Shift", None))
    # retranslateUi
